...
export default function ShoppingCartThree () {
  ...
  return (
    <div className="flex flex-col mx-auto max-w-3xl p-6 space-y-4 sm:p-10 dark:text-gray-100">
              ...
              <div className="flex flex-col justify-between w-full pb-4">
                ...
                <div className="flex text-sm divide-x">
                  ...
                  >
                    ...
                    <span onClick={()=>{deletecart(item.id)}}>Remove</span>
                  </button>
                  <button
                    type="button"
